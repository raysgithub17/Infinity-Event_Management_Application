...
public class MyConstant {
    ...
    public static final String SWAGGER_INFO_DESCRIPTION ="Infinity-EventManagement";
    public static final String SWAGGER_INFO_VERSION ="1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME ="Rayhan";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs75@skcet.ac.in";
